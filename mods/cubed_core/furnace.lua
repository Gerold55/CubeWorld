...
minetest.register_node("cubed_core:furnace_top", {
  description = "pot",
  tiles = {
    {
...
minetest.register_node("cubed_core:furnace_top_active", {
...
minetest.register_abm({
  nodenames = {"cubed_core:furnace_top", "cubed_core:furnace_top_active"},
  interval = 1.0,
  chance = 1,
  action = function(pos, node)
    ...
    if is_hot_below(pos) then
      was_active = true
      minetest.swap_node(pos,{name = "cubed_core:furnace_top_active", param2 = node.param2})
      ...
      if cooked and cooked.item and percent >= 100 then
       ...
       minetest.swap_node(pos,{name="cubed_core:furnace_top", param2 = node.param2})
    end
...
minetest.register_node("cubed_core:furnace_bottom", {
...
minetest.register_node("cubed_core:furnace_bottom_active", {
  ...
  drop = "cubed_core:furnace_bottom",
  is_ground_content = false,
  on_construct = function(pos)
    local meta = minetest.get_meta(pos)
    meta:set_string("formspec", furnace_bottom_formspec())
...
minetest.register_abm({
  nodenames = {"cubed_core:furnace_bottom","cubed_core:furnace_bottom_active"},
  interval = 1.0,
  chance = 1,
  action = function(pos, node)
    local meta = minetest.get_meta(pos)
    ...
    if meta:get_float("fuel_time") < meta:get_float("fuel_totaltime") then
      ...
      minetest.swap_node(pos,{name = "cubed_core:furnace_bottom_active", param2 = node.param2})
    ...
    if fuel and fuel.time > 0 then
      ...
      minetest.swap_node(pos,{name = "cubed_core:furnace_bottom", param2 = node.param2})
      meta:set_string("formspec", furnace_bottom_formspec())
    end
  end,
})
