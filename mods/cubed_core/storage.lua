minetest.register_node("cubed_core:barrel", {
	description = "Barrel",
	paramtype2 = "facedir",
	tiles = {
...
minetest.register_node("cubed_core:clay_pot", {
	...
	on_punch = function(pos, node, clicker, itemstack)
		...
		meta:set_string('formspec',
				...
				'list[current_player;main;0,4;8,4;]'..
				'listring[]')
		node.name = "cubed_core:clay_pot_opened"
...
minetest.register_node("cubed_core:clay_pot_opened", {
